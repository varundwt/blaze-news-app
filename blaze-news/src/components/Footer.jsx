...
export const Footer = () => {
  return (
    <footer className="footer footer-center bg-gray-950 text-base-content rounded p-10 mt-32">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          <a href="https://github.com/varundwt/blaze-news-app">
            <svg
          ...
          <a href="https://www.linkedin.com/in/semiintrovert/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a href="https://varunpandey-portfolio.vercel.app/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
